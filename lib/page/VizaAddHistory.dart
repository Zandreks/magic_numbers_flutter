...
class VizaAddHistory extends StatefulWidget {
  VizaAddHistory({Key key}) : super(key: key);
  @override
  _VizaAddHistoryState createState() => _VizaAddHistoryState();
}

class _VizaAddHistoryState extends State<VizaAddHistory> {
  String lang = 'RU';
  String titleBar = '';
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Container(
                                      padding: const EdgeInsets.all(10),
                                      child: Text(
                                        "${oCcy.format(history.countMonth)}",
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            child: Text(
                                              lang == "RU"
                                                  ? "Сумма на счёте с займом:"
                                                  : "Amount on the account with the loan:",
                                              overflow: TextOverflow.clip,
                                              style: TextStyle(
                                                fontFamily: "SF Pro Display",
                                                fontSize: 12,
