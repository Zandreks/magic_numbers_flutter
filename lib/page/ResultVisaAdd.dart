...
class ResultVisaAdd extends StatefulWidget {
  ResultVisaAdd({Key key}) : super(key: key);
  @override
  _ResultVisaAddState createState() => _ResultVisaAddState();
}

class _ResultVisaAddState extends State<ResultVisaAdd> {
  String lang = 'RU';
  String titleBar = '';
